...
export default function SourceDocs({ sourceDocs, index, isNeoBot }) {
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        >{`Source Documents for message ${index}`}</DialogTitle>
              ...
              >
                ...
                <AccordionDetails>
                  ...
                  <Typography>
                    ...
                    {isNeoBot
                      ? doc.metadata.source
                      : doc.metadata.source.substring(22)}
                  </Typography>
                </AccordionDetails>
              </Accordion>
            ))}
